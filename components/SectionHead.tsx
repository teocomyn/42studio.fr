...
export function SectionHead({ eyebrow, title, body, as: Tag = "h2" }: SectionHeadProps) {
  return (
    <Reveal className="mb-12 flex flex-col gap-5 md:mb-20 md:grid md:grid-cols-[minmax(12rem,24rem)_1fr] md:items-end">
      <span className="mono-label">{eyebrow}</span>
      <div>
        <Tag className="max-w-4xl text-[clamp(2.2rem,5vw,5rem)] font-light leading-[0.95] tracking-[-0.045em] text-balance">
          {title}
        </Tag>
